...
<?php
    ...
    if (isset($_REQUEST['name'])){
		...
		$degree_id = stripslashes($_REQUEST['degree_id']);
		$degree_id = mysqli_real_escape_string($con,$degree_id);
        $query = "INSERT into `courses` (name, degree_id) VALUES ('$name', SELECT as '$degree_id' FROM `degrees`)";
...
<div id="UpdatePanel1">
  <table align="center" width="100%" border="0" cellspacing="30" cellpadding="0" class="login_tbl">
    <tr>
      ...
      <td><select name="degree_id" class="select_ums">
    ...
    <tr>
      ...
      <td><input name="name" type="text" class="input_type" id="name" placeholder="Duration" required="required" /></td>
    </tr>
	  <tr>
